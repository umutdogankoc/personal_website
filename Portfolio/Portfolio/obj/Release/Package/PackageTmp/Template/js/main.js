...
function contactFormSetup() {
    ...
    $('#contact-form').on('submit', function(e) {
        e.preventDefault();
        var model = {};
        model.Email = $('#cf-email').val();
        model.Name = $('#cf-name').val();
        model.Message = $('#cf-message').val();
        var $messageBox = $('#contact-form .message');
            ...
            $.ajax({
                ...
                success: function (model) {
                    if (model.State == true) {
                        ...
                        $("#contact-form .input__field").prop('disabled', 'true');
                        $("#cf-submit").prop('disabled', 'true');
                        showAlertBox(200, model.SuccessMessage);
